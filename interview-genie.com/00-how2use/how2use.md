...
##### 设置“自然语言”
用于指定语音识别和AI回复所使用的主要语种。支持中文、英语、日语、韩语、德语、法语、西班牙语、意大利语、俄语等语种的面试。其中“中英文”、“English(New)”、“日本語”、“한국어”、“Deutsch”、“Français”、“Español”、“Italiano”、“Русский”等选项，使用了最新升级版语音识别系统。升级版语音识别系统提升了英文技术术语识别能力，技术面试中推荐选择“中英文”，详情查看：<a href="https://interview-genie.com/blog/upgrade-asr/" target="_blank" rel="noopener noreferrer" style="text-decoration: underline;">【面试精灵重磅升级】英文技术词识别率提升22%，新增多语言面试支持！</a>。
